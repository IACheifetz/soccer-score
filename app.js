...
const teamOneEl = document.getElementById('team-one');
const teamTwoEl = document.getElementById('team-two');
...
nameFormButton.addEventListener('click', () => {
    ...
    const currentNameEl1 = teamOneEl.value;
    const currentNameEl2 = teamTwoEl.value;
    // set the state to this data from the form
    name1 = currentNameEl1;
    name2 = currentNameEl2;
